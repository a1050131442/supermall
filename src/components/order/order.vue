...
<el-table :data="orderlist" border stripe>
  <el-table-column type="index"></el-table-column>
   ...
   <el-table-column label="操作">
     <template>
       <el-button size="mini"  type="primary" icon="el-icon-edit" @click="dishow"></el-button>
...
<el-dialog
  ...
  width="50%"
  @close="addressfialogcloes">
  <el-form :model="addressfrom" :rules="addressfromrules" ref="addressfromref" label-width="100px">
    <el-form-item label="省市区/县" prop="address1">
   <el-cascader :options="citdata" v-model="addressfrom.address1"></el-cascader>
    </el-form-item>
...
<script>
import citdata from './citydata.js'
export default {
  data () {
    return {
      queryinfo: {
